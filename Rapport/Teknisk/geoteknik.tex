...
\begin{figure}[htbp] \centering
	\begin{minipage}[b]{0.48\textwidth}\centering
		\includegraphics[width=1.0\textwidth]{billeder/forskudningsspanning.png}
		\caption{BILLEDTEKST}
...
\begin{figure}[htbp]
		\includegraphics[width=1.2\textwidth]{billeder/sigtekurve1.png}
...
\begin{figure}[htbp]
		\centering
		\includegraphics[width=1.2\textwidth]{billeder/sigtekurve2.png}
