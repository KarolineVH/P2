...
\begin{figure}[H]
	...
	\caption{Snit for statisk system}
	\label{fig:snitbrud}
\end{figure}
...
Ud fra snittene udarbejdes snitkurver, som er illusteret på Figur \ref{fig:forskydningskurve}, Figur \ref{fig:momentkurve} og Figur \ref{fig:normalkraftkurve}. 

\begin{figure}[H]\centering
	\begin{minipage}[b]{0.48\textwidth}\centering
		\includegraphics[width=0.8\textwidth]{billeder/sk.png} %Venstre billede
	\end{minipage}\hfill
	\begin{minipage}[b]{0.48\textwidth}\centering
		\includegraphics[width=1.0\textwidth]{billeder/SKFN.png} %Højre billede
	\end{minipage}\\ %Captions and labels
	\begin{minipage}[t]{0.48\textwidth}
		\caption{Forskydningskurve angivet i [kN]} %Venstre caption og label
		\label{fig:forskydningskurve}
	\end{minipage}\hfill
	\begin{minipage}[t]{0.48\textwidth}
		\caption{Normalkraftkurve angivet i [kN]} %Højre caption og label
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{billeder/skkm.png}
	\caption{Momentkurve angivet i [kNm]}
