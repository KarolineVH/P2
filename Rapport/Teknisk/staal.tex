læde\chapter{Brudgrænsetilstand}
...
\begin{figure}[H]\centering
	\begin{minipage}[b]{0.48\textwidth}\centering
		\includegraphics[width=1.1\textwidth]{billeder/sk.png} %Venstre billede
	\end{minipage}\hfill
	\begin{minipage}[b]{0.48\textwidth}\centering
		\includegraphics[width=0.9\textwidth]{billeder/SKFN.png} %Højre billede
	\end{minipage}\\ %Captions and labels
	\begin{minipage}[t]{0.48\textwidth}
		\caption{Forskydningskurve} %Venstre caption og label
		\label{fig:forskydningskurve}
	\end{minipage}\hfill
	\begin{minipage}[t]{0.48\textwidth}
		\caption{Normalkraftkurve} %Højre caption og label
