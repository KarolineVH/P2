...
\begin{table}[htb]
	\begin{center}
		...
		\hline
		Dybde & Jordlast \\
		[m] & $p_x,linje$ [$\frac{\text{kN}}{\text{m}}$] \\ \hline
		0 & 0 \\ 
		2 & 116,32
		\end{tabular}
...
\begin{table}[htb]
	\begin{center}
		\begin{tabular}{ c c c c c } 
			\hline
			\multirow{2}{*}{Zone/Formfaktor} & \multicolumn{2}{}{$c_{pe,10 udvendig}$} & \multicolumn{2}{}{$c_{pe,10 indvendig}$} \\ 
...
\begin{table}[htb]
	\begin{center}
		\begin{tabular}{ c c c c } 
			\hline
			\multirow{2}{*}{Zone/Formfaktor} & $c_{pe,10 udvendig}$ & \multicolumn{2}{}{$c_{pe,10 indvendig}$} \\	
...
\begin{table}[htb]
	\begin{center}
		\begin{tabular}{ c c c c } 
			\hline
			\multirow{2}{*}{Zone/Formfaktor} & \multirow{2}{*}{$c_{pe,10}$ udvendig} & \multicolumn{2}{}{$c_{pe,10}$ indvendig} \\ 
