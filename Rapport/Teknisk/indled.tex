...
\begin{table}
	\begin{center}
		\begin{tabular}{|c|c|c|}
			...
			Mursten  & 1500 \citep{murstendensitet} & 130 \citep{indervaeg}    \\ \hline
			Rockwool & 30 \citep{densitet} & 100 \citep{isolering}             \\ \hline
		\end{tabular}
		\caption{Materialer og deres egenskaber for væg}
		\label{tab:murogwool}
	\end{center}
\end{table}
...
\newline \indent{     }  Når arealet af facaderne beregnes trækkes arealet af vinduerne samt døren fra, da disse antages at belaste ydermuren. Arealet og lasten for facaderne og gavlen kan ses i Tabel \ref{tab:arealoglast}.
...
\begin{table}
	\begin{center}
		\begin{tabular}{|c|c|c|}
			...
			Facade, vest & 181,175 & 352,269 \\ \hline
			Facade, øst  & 181,175 & 352,269 \\ \hline
			Gavl, nord   & 197,175 & 383,379 \\ \hline
		\end{tabular}
		\caption{Materialer og deres egenskaber for væg}
...
Ligningen for jordlasten findes ved: 
...
\begin{itemize}
	\item[-] x: længden kraften virker over
	\item[-] p: den største kraft
\end{itemize}

Hermed fås ligningen: $w = \frac{1}{2} 116,\!32 \frac{kN}{m} x$
