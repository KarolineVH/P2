...
\begin{equation}
	p_{\textup{strøer}} = \SI{7,84}{m^3} \cdot 510 [$\frac{\text{kg}}{\text{m}^3}$] \cdot \SI{9,82}{$\frac{\text{m}}{\text{s}^2}$} \cdot 4 = \SI{157,06}{kN}
\end{equation}
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{c c c c c}
			\hline
			Materiale & Densitet & Tykkelse & Volumen & Last \\
			& \textit{d} [$\frac{\text{kg}}{\text{m}^3}$] & \textit{t} [mm] & \textit{V} [$\text{m}3$] & \textit{p} [kN] \\ \hline
			Strøer & - & 140 & 7,84 & 157,06	\\
			Beton    & 2400     & 120 & 72,00 & 1693,44      \\ 
			Rockwool & 30       & 140 & 52,64 & 15,51     \\ 
			Linoleum & 2,9      & 2,5 & 1,50 & 0,04 \\ 
		\end{tabular}
