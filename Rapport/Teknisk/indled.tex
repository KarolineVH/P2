...
\newline
\newline
Rumfanget af én bjælke, som består af to bjælker med længden $6,\!25$ m, ganges med bjælkens densitet for tørrumvægt af træ \citep{torrumvagt}, som er , hvorefter denne værdi ganges med tyngdeaccelerationen og ganges med 4: 
\begin{center}
	$p{bjælker} = 7,\!84 m^3\cdot 510 \frac{kg}{m^3}\cdot 9,\!82 \frac{m}{s^2}\cdot 4 = 157,\!06 kN$
\end{center}

Volumen af betonen for én etage bestemmes til:
\begin{center}
