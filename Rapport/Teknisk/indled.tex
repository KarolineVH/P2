...
\begin{table}[htb]
	\begin{center}
		\begin{tabular}{ |c|c|c|c|c| } 
			\hline
			Zone/Formfaktor & Positiv udv.& Negativ udv. & Positiv ind. & Negativ ind. \\	\hline
...
\begin{table}[htb]
	\begin{center}
		\begin{tabular}{ |c|c|c|c| } 
			\hline
			Zone/Formfaktor & Negativ udv. & Positiv ind. & Negativ ind. \\	\hline
...
\newline
\newline
Enheden skal være $[\frac{kN}{m}]$, og derfor multipliceres med længden mellem hver af vores stænger, som er 6,25 m. - SE BILLEDET I STARTEN AF KONSTRUKTIONSAFSNIT! 
