...
\newline
Densiteten for den anvendte ståltype S235 med profil nr. 450 har densiteten $g = 115\frac{kg}{m}$ \citep{stabi}. Dette skal multipliceres med højden af sadeltaget, som er $6,\!7 m$. Dette skal også multipliceres med to, da der går to stålstænger op til taget. Derefter omregnes der til [N].
\begin{center}
	$115\frac{kg}{m}\cdot 6,\!7m \cdot 9,\!82\frac{m}{s^2} = 7,\!58 kN$
\end{center}
