...
\end{center}
\begin{itemize}
	\item[-] $\mu_w$: formfaktoren
\end{itemize}
Formfaktoren, $\mu_w$, bestemmes ved:
\begin{center}
$\mu_w=2.4-0.04\cdot \alpha$
\end{center}
\begin{itemize}
	\item[-] $\alpha$: taghældningen målt fra vandret, som sættes til $26.565^{\circ}$
\end{itemize}
Formfaktoren kan nu bestemmes til:
\begin{center}
	$\mu_w=2.4-0.04\cdot 26.565=1.337$
\end{center}
Den karakteristiske snelast for lasttilfælde 4 kan nu bestemmes til:
\begin{center}
	$s_4=1.337\cdot 1.0\cdot 1.0\cdot 1 \frac{kN}{m^2}=1.337 \frac{kN}{m^2}$
\end{center}
