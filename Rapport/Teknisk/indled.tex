...
\underline{Gavl}
\newline
Da den ene gavl ligger op ad den nuværende bygning, vil der ikke være vinduer på denne gavl, mens der antages at være 9 vinduer, identiske med dem for facaden, for gavlen, der ikke ligger op ad den nuværende bygning, som kan ses på Figur \ref{fig:gavl}. Til forskel for facadens areal, har gavlene også arealet for tagetagen, som har dimensionerne der ses på Figur \ref{fig:tagetage}. Arealet for facaden der ikke ligger op ad den nuværende bygning bestemmes dermed til:
\begin{center}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\textwidth]{billeder/facadevestellerøst.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{billeder/snelasttilfælde.png}
