...
\newcommand\AR[1]{\makebox[0pt][l]{$#1$}\kern0.0em\raisebox{1.5ex}{$\curvearrowright$}}						% Andre matematik- og tegnudvidelser
...
\makeevenhead{AAU}{Gruppe B228}{}{\leftmark}				% Definerer lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
